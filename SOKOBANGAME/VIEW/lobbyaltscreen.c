...
int show_alt_menu(int selected, int items, Button *btnset){
    ...
    mvprintw(LINES-6, 2, "Klik Kiri untuk memilih menu");
    mvprintw(LINES-5, 2, "Atau gunakan tombol panah");
    mvprintw(LINES-4, 2, "Untuk navigasi.");
    mvprintw(LINES-3, 2, "Tekan ENTER untuk memilih");
}
